        ...
        <div className='flex justify-between'>
          <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
            <div>
              ...
              <DatePicker selected={arrival} onChange={date => setArrival(date)} className='w-2/3' />
            </div>
          ...
          <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
            <div>
              ...
              <DatePicker selected={departure} onChange={date => setDeparture(date)} className='w-2/3' />
            </div>
